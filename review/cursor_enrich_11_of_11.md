# PermiePortal — Enrichment Batch 11 of 11

> **Agent mode only.** ONE session at a time.
> This batch: 11 plants. Total remaining: 211 plants + 0 pest fields.
...
- `src/seeds/plants/wild-petunia-data.yml` (11 fields)
- `src/seeds/plants/wild-plum-data.yml` (11 fields)
- `src/seeds/plants/wild-stonecrop-data.yml` (11 fields)
- `src/seeds/plants/wingleaf-soapberry-data.yml` (11 fields)
- `src/seeds/plants/wiregrass-data.yml` (11 fields)
- `src/seeds/plants/wood-apple-data.yml` (11 fields)
- `src/seeds/plants/yellow-coneflower-data.yml` (11 fields)
- `src/seeds/plants/yellow-mombin-data.yml` (11 fields)
- `src/seeds/plants/yellow-waterlily-data.yml` (11 fields)
- `src/seeds/plants/zamia-integrifolia-data.yml` (11 fields)
- `src/seeds/plants/zigzag-spiderwort-data.yml` (11 fields)
---
...
./sync.sh --check
./sync.sh
rm review/cursor_enrich_11_of_11.md
```

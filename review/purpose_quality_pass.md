...
Each purpose entry must use this format:
Function Name: Specific explanation of how this plant performs this function in a permaculture system -- what part, what benefit, what system behavior.

Be specific, not generic.
Bad: "Edible: The fruit is edible."
Good: "Edible: Ripe fruit harvested when skin gives slightly -- sweet-tart pulp eaten fresh, dried, or juiced; seeds roasted like nuts; young leaves used as pot herb."

Capture ALL documented permaculture functions for that plant:
...
Use ' -- ' not em dashes — em dashes cause YAML parse errors.

Match the plant_function tags already in the file. If plant_function lists
...
Do not add functions that do not apply. Use judgment.

Minimum 3 functions per plant. Most plants should have 4-8.

# PermiePortal — Enrichment Batch 3 of 11
...
- `src/seeds/plants/climbing-prairie-rose-data.yml` (11 fields)
- `src/seeds/plants/cloudberry-data.yml` (11 fields)
- `src/seeds/plants/coastalplain-honeycombhead-data.yml` (11 fields)
- `src/seeds/plants/cockspur-hawthorn-data.yml` (11 fields)
- `src/seeds/plants/coconut-palm-data.yml` (11 fields)
- `src/seeds/plants/coontie-palm-data.yml` (11 fields)
- `src/seeds/plants/crimson-beebalm-data.yml` (11 fields)
- `src/seeds/plants/crowberry-data.yml` (11 fields)
- `src/seeds/plants/curry-leaf-tree-data.yml` (11 fields)
- `src/seeds/plants/cythera-data.yml` (11 fields)
- `src/seeds/plants/dense-blazingstar-data.yml` (11 fields)
- `src/seeds/plants/dotted-hawthorn-data.yml` (11 fields)
- `src/seeds/plants/downy-myrtle-data.yml` (11 fields)
- `src/seeds/plants/downy-rose-myrtle-data.yml` (11 fields)
- `src/seeds/plants/downy-serviceberry-data.yml` (11 fields)
- `src/seeds/plants/dwarf-palmetto-data.yml` (11 fields)
- `src/seeds/plants/eastern-blazingstar-data.yml` (11 fields)
- `src/seeds/plants/eastern-columbine-data.yml` (11 fields)
- `src/seeds/plants/eastern-gamagrass-data.yml` (11 fields)
- `src/seeds/plants/elderberry-wine-data.yml` (11 fields)
---
...
./sync.sh --check
./sync.sh
rm review/cursor_enrich_3_of_11.md
```

Zero warnings required before the next batch.

Next: `cursor_enrich_4_of_11.md`

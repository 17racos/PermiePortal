...
A leading voice in adaptive architecture notes: *"The patch represents the largest unsolicited materials deposit in human history. The only thing missing is the will to do something with it."* We have the will. We have always had the will. We simply also had plastic straws to argue about, which consumed the available bandwidth.
...
We did not ask for this amenity. It was included at no extra charge.
...
We built an island by accident while arguing about straws.
